...
void num_flux_rus(const float wL[3], 
                  const float wR[3], 
                  const float vn[2], 
                  float flux[3])
{
   ...
   flux[0] = 0.5F*wL[0] - 0.5F*wR[0] - x0*(wL[2] + wR[2]) - x1*(wL[1] + wR[1]);
...
void num_flux_rus(const float wL[4], 
                  const float wR[4], 
                  const float vn[3], 
                  float flux[4])
{
   ...
   const float x1 = 0.288675135F*vn[1];
   const float x2 = wL[0] + wR[0];
   flux[0] = 0.288675135F*vn[2]*(wL[2] + wR[2]) + 0.5F*wL[0] - 0.5F*wR[0] - x0*(wL[3] + wR[3]) - x1*(wL[1] + wR[1]);
   flux[1] = 0.5F*wL[1] - 0.5F*wR[1] - x1*x2;
